...
import { submitLeaveForm } from "@/components/submitLeaveForm";
...
export default function LeaveForm() {
  ...
  async function submitForm() {
    const isConfirmed = await submitLeaveForm(
            ...
            <View style={styles.picker}>
              ...
              >
                <Picker.Item
                  ...
                  enabled={false}
                />
                <Picker.Item label="Vacation Leave (VL)" value="VL" />
                <Picker.Item label="Sick Leave (SL)" value="SL" />
                <Picker.Item label="Emergency Leave (EL)" value="EL" />
                <Picker.Item label="Other (OL)" value="OL" />
              </Picker>
            </View>
          </View>
